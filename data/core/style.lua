...
style.font = renderer.font.load(EXEDIR .. "/data/fonts/SF-Pro-Text-Regular.ttf", 16 * SCALE)
style.big_font = renderer.font.load(EXEDIR .. "/data/fonts/SF-Pro-Text-Regular.ttf", 34 * SCALE)
style.icon_font = renderer.font.load(EXEDIR .. "/data/fonts/icons.ttf", 16 * SCALE)
style.code_font = renderer.font.load(EXEDIR .. "/data/fonts/BerkeleyMono-Regular.ttf", 16 * SCALE)
